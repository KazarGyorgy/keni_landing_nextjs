    ...
    >
      <article className="glass-card p-6 md:h-full text-center group hover:bg-white/10 transition-all duration-300">
        <div className="relative z-10 mb-6">
          ...
          <span
            className="absolute -top-2 -right-2 w-7 h-7 rounded-full bg-primary-800 border-2 border-accent-500 flex items-center justify-center text-accent-400 text-xs font-bold"
            aria-hidden="true"
          >
            {step.number}
          </span>
      ...
      {!isLastStep && (
        <div
          className="lg:hidden flex justify-center mt-6 mb-0"
          aria-hidden="true"
        >
          <motion.div
            animate={{ y: [0, 5, 0] }}
