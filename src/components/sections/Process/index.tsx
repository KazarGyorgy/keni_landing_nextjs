...
function ProcessContent() {
  ...
  return (
    <section
      id="process"
      className="section-padding relative content-visibility-auto"
    >
      <div
        className="absolute inset-0 bg-gradient-to-b from-transparent via-primary-800/20 to-transparent"
        aria-hidden="true"
      />
      ...
      <div className="container-custom mx-auto relative z-10">
        ...
        >
          <div
            className="hidden lg:block absolute top-[3.5rem] left-[12.5%] right-[12.5%] h-0.5 bg-gradient-to-r from-accent-500/20 via-accent-500/40 to-accent-500/20 z-0"
            aria-hidden="true"
          />
