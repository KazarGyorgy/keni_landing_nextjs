    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container-custom mx-auto px-4 md:px-8 pt-20 pb-16">
        ...
        >
          <motion.div
            variants={fadeInUp}
            className="mb-8 flex flex-row flex-wrap justify-center gap-x-8 gap-y-3"
          >
            {["loan", "independent", "insurance", "update", "savings"].map(
              (key) => (
                <span
                  key={key}
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent-500/10 border border-accent-500/20 text-accent-400 text-sm font-medium"
                >
                  <span
